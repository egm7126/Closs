        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              TextButton(
                onPressed: () async {
                  _bluetoothClassicPlugin.connect("D8:3A:DD:E6:E1:40", "00001101-0000-1000-8000-00805F9B34FB");
                  await _bluetoothClassicPlugin.write("how are you");
                },
                child: const Text("Send 'how are you' to D8:3A:DD:E6:E1:40"),
              ),
            ],
          ),
        ),
